...
<div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-white mb-2">Yangi Foydalanuvchi Qo'shish</h1>
        <p class="text-gray-400">Tizimga yangi foydalanuvchi qo'shish va rol biriktirish</p>
    </div>
